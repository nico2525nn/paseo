...
/**
 * Shared mobile drag affordance: long-press arms a draggable-flatlist drag with haptics,
 * arbitrating against vertical scroll, horizontal swipe, and an optional context-menu open.
 *
 * Web does not exercise this — `dragHandleProps` from `DraggableList` covers web DnD.
 */
